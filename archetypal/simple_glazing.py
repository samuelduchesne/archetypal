...
def calc_simple_glazing(shgc, u_factor, visible_transmittance=None):
    ...
    Hint:
        ...
        <https://bigladdersoftware.com/epx/docs/8-9/engineering-reference/window-calculation-module.html#simple-window-model>`_.
...
def r_i_w(u_factor):
    """
    The resistance of the interior film coefficient under standard winter conditions in units of m\ :sup:`2`\ K/W

    Args:
        u_factor: The U-value of the window including interior and exterior surface heat transfer coefficients

    Returns:
        The resistance of the interior film coefficient under standard winter conditions
...
def r_o_w(u_factor):
    """
    The resistance of the exterior film coefficient under standard winter conditions in units of m\ :sup:`2`\ K/W

    Args:
        u_factor: The U-value of the window including interior and exterior surface heat transfer coefficients

    Returns:
        The resistance of the exterior film coefficient under standard winter conditions in units of
...
def r_l_w(u_factor):
    """
    The resisance of the bare window under winter conditions (without the film coefficients) in units of
    m\ :sup:`2`\ K/W.

    Args:
        u_factor: The U-value of the window including including interior and exterior surface heat transfer
        coefficients.
    ...
    Warnings:
        The model cannot support glazing systems with a U-value higher than 7.0 because the thermal resistance of
...
def thickness(r_l_w):
    ...
    Args:
        r_l_w (double): The resisance of the bare window under winter conditions (without the film coefficients) in
...
def lambda_eff(thickness, r_l_w):
    ...
    Args:
        ...
        r_l_w: The resisance of the bare window under winter conditions (without the film coefficients) in
            units of m\ :sup:`2`\ K/W.

    Returns:
        The effective thermal conductivity, λ\ :sub:`eff`, of the equivalent layer.
...
def r_s_f(t_sol, shgc, r_o_s, r_l_w, r_i_s):
    ...
    Notes: The solar reflectance of the back face is the same as the solar reflectance of the front face.

    Args:
        t_sol (double): The Solat Transmittance at normal incidence.
        shgc (double): The window's Solar Heat Gain Coefficient
        r_o_s (double): Resistance of the outside coefficient under summer conditions.
        r_l_w (double): The resisance of the bare window under winter conditions (without the film
            coefficients) in units of m\ :sup:`2`\ K/W.
        r_i_s (double): Resistance of the inside coefficient under summer conditions.
