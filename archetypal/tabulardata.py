...
class TabularData(pd.DataFrame):
    ...
    def filter_tabular_data(self, archetype=None, tabulardataindex=None,
                            value=None, reportname=None, reportforstring=None,
                            tablename=None, rowname=None, columnname=None,
                            units=None, inplace=False):
        ...
        if archetype:
            ...
            c_n.append(c_1)
        if tabulardataindex:
            c_2 = conjunction(*[self[self.TABULARDATAINDEX] ==
                                tabulardataindex for
                                tabulardataindex in
                                tabulardataindex],
            ...
            c_n.append(c_2)
        if value:
            c_3 = conjunction(*[self[self.VALUE] ==
                                value for
                                value in
                                value],
                              logical=np.logical_or) \
            ...
            c_n.append(c_3)
        if reportname:
            c_4 = conjunction(*[self[self.REPORTNAME] ==
                                reportname for
                                reportname in
                                reportname],
                              logical=np.logical_or) \
                if isinstance(reportname, tuple) \
                else self[self.REPORTNAME] == \
                     reportname
            c_n.append(c_4)
        if value:
            ...
            c_n.append(c_5)
        if reportforstring:
            c_6 = conjunction(*[self[self.REPORTFORSTRING] ==
                                reportforstring for
                                reportforstring in
                                reportforstring],
                              logical=np.logical_or) \
            ...
            c_n.append(c_6)
        if tablename:
            c_7 = conjunction(*[self[self.TABLENAME] ==
                                tablename for
                                tablename in
                                tablename],
                              logical=np.logical_or) \
            ...
            c_n.append(c_7)
        if rowname:
            c_8 = conjunction(*[self[self.ROWNAME] ==
                                rowname for
                                rowname in
                                rowname],
                              logical=np.logical_or) \
            ...
            c_n.append(c_8)
        if columnname:
            c_9 = conjunction(*[self[self.COLUMNNAME] ==
                                columnname for
                                columnname in
                                columnname],
                              logical=np.logical_or) \
