...
#   timestamp: 2023-09-18T21:36:53+00:00
...
class DomesticHotWaterSetting(BaseModel):
    id: UUID4 = Field(..., title='Object ID')
    WaterSupplyTemperature: confloat(ge=0.0) = Field(
        ...,
...
class ZoneConditioning(BaseModel):
    id: UUID4 = Field(..., title='Object ID')
    HeatingSetpoint: confloat(ge=40.0, le=84.0) = Field(
        ...,
        description='Heating Setpoint for HVAC Systems',
        examples=[52, 60],
        title='Heating Setpoint',
    )
    CoolingSetpoint: confloat(ge=60.0, le=90.0) = Field(
        ...,
...
class ZoneLoads(BaseModel):
    ...
    EquipmentPowerDensity: confloat(ge=0.0, le=50.0) = Field(
        ...,
