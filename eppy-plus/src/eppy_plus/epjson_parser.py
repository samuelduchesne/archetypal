"""
Native epJSON parser - parses EnergyPlus epJSON files into IDFDocument.

The epJSON format is the native JSON representation of EnergyPlus models.
Parsing is trivial since it's already structured JSON.
"""
...
from .exceptions import VersionNotFoundError, EppyPlusError
...
def parse_epjson(
    ...
    Raises:
        ...
        EppyPlusError: If parsing fails
    """
