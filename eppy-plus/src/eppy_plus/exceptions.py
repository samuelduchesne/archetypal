"""Custom exceptions for eppy-plus."""
...
class EppyPlusError(Exception):
    """Base exception for all eppy-plus errors."""

    pass


# Alias for backwards compatibility
ParseError = EppyPlusError


class SchemaNotFoundError(EppyPlusError):
...
class DuplicateObjectError(EppyPlusError):
...
class UnknownObjectTypeError(EppyPlusError):
...
class InvalidFieldError(EppyPlusError):
...
class VersionNotFoundError(EppyPlusError):
...
class DanglingReferenceError(EppyPlusError):
...
class ValidationFailedError(EppyPlusError):
