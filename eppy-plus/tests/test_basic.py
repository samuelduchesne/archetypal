...
def test_import():
    ...
    import eppy_plus
    assert eppy_plus.__version__ == "0.1.0"


def test_load_idf():
    """Test loading an IDF file."""
    from eppy_plus import load_idf
...
def test_new_document():
    ...
    from eppy_plus import new_document
...
def test_write_idf():
    ...
    from eppy_plus import new_document, write_idf
