...
'NominalElectricEquipment':{'PrimaryKey':['NominalElectricEquipmentIndex'],'ParseDates':[]},
'NominalGasEquipment':{'PrimaryKey':['NominalGasEquipmentIndex'],'ParseDates':[]},
'NominalHotWaterEquipment':{'PrimaryKey':['NominalHotWaterEquipmentIndex'],'ParseDates':[]},
...
'SystemSizes':{'PrimaryKey':['SystemSizesIndex'],'ParseDates':{'PeakHrMin':'%m/%d %H:%M:%S'}},
...
'Simulations':{'PrimaryKey':['SimulationIndex'],'ParseDates':{'TimeStamp':{'format':'YMD=%Y.%m.%d %H:%M'}}},
